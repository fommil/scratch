 ...
 * even though it was better code. the i resized a few arrays and got
 *  time: 0:00.016 mem: 64
 *
...
void readpoly (signed int poly[101][101]);
void printpoly (signed int poly[201][201]);
void multpoly (signed int out[201][201], signed int p1[101][101],
	       signed int p2[101][101]);

int
main ()
{
  signed int inPolyLeft[101][101], inPolyRight[101][101], outPoly[201][201];
  signed int x, y, eof;
...
void
readpoly (signed int poly[101][101])
{
  signed int v, x, y;
  unsigned char c, d = 0, eol = 0;
...
void
multpoly (signed int out[201][201], signed int p1[101][101],
	  signed int p2[101][101])
{
